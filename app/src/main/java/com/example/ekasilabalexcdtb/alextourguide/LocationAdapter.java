 ...
 */
public class LocationAdapter extends ArrayAdapter<com.example.ekasilabalexcdtb.alextourguide.Location> {

    public LocationAdapter(Context context, int resources, List<com.example.ekasilabalexcdtb.alextourguide.Location> locationsList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final com.example.ekasilabalexcdtb.alextourguide.Location currentLocation = getItem(position);
