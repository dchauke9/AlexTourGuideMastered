 ...
 */
public class LocationAdapter extends ArrayAdapter<com.example.ekasilabalexcdtb.gomoratourguide.Location> {

    public LocationAdapter(Context context, int resources, List<com.example.ekasilabalexcdtb.gomoratourguide.Location> locationsList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final com.example.ekasilabalexcdtb.gomoratourguide.Location currentLocation = getItem(position);
